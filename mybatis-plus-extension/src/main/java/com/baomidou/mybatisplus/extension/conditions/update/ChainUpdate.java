...
//        return typedThis.execute(mapper -> SqlHelper.retBool(mapper.update(entity, typedThis.delegate())));
//    }
//
//    /**
//     * 删除数据
...
//        return typedThis.execute(mapper -> SqlHelper.retBool(mapper.delete(typedThis.delegate())));
//    }
//}
